          ...
          <div className="flex items-center justify-between mt-4 pt-4 border-t border-gray-200">
            <div className="flex items-center gap-2 text-sm text-gray-600">
              ...
              {selectedCategory !== 'all' && (
                <span className="bg-green-100 text-green-800 px-2 py-1 rounded">Category: {selectedCategory}</span>
              )}
              {sortBy !== 'default' && (
                <span className="bg-purple-100 text-purple-800 px-2 py-1 rounded">Sort: {sortBy}</span>
              )}
            </div>
            <button
